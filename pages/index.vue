...
<template>
	<div class="flex-1 flex flex-col bg-red-100 h-screen">
		<div id="hero" class="h-[calc(100vh-70px)] relative">
			...
			<div class="h-72 absolute right-0 bottom-0 left-0 z-30 p-6 text-white flex-flex-col justify-start">
