  ...
  definePerson({
    ...
    mainEntityOfPage: [
      ...
      },
      {
		...
		sameAs: [
      'https://www.imdb.com/name/nm1125257/?ref_=nv_sr_srsg_0_tt_0_nm_8_in_0_q_deana%2520becker'
    ]
  }),
  defineVideo({
...
<template>
	<div class="flex h-[100vh] flex-1 flex-col">
