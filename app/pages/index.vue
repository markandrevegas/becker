...
<template>
	<main class="flex w-full flex-1 flex-col overflow-x-hidden">
		...
		<div id="intro" ref="introRef" :class="['transition-opacity delay-500 duration-1000 md:px-8 md:pb-16', isIntroVisible ? 'animate-fade-slide-up' : 'opacity-0']">
		...
		<div id="bio" ref="bioRef" :class="['transition-opacity delay-500 duration-1000 md:px-8 md:pb-16', isBioVisible ? 'animate-slide-fade-left' : 'opacity-0']">
			<IndexBio :header="acf?.bioheader" :content="acf?.bioparagraph" />
		</div>
	</main>
</template>
