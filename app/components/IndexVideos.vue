		...
		<div class="flex flex-col gap-4 sm:flex-row sm:items-center">
			<div class="gallery-container relative w-full">
				...
				<div class="flex flex-col absolute bottom-0 left-0 right-0 z-30 h-72 justify-end px-8 pb-16 text-white sm:p-16 sm:hidden">
					<h2 class="mt-2 max-w-md font-display text-display-lg drop-shadow-[1px_3px_5px_rgba(0,0,0,0.8)]">{{ header }}</h2>
				</div>
			</div>
			<div class="content px-8 py-24">
				<h2 class="hidden sm:block mt-2 mb-8 w-full max-w-md font-display text-display-lg">{{ header }}</h2>
				<p>
					{{ content }}
				</p>
